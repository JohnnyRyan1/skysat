...
U-Net model proposed by Ronneberger et al. (2015) 

Also used by Wieland and Martinis (2019).
...
# Save model
model.save(path2 + 'models/ronneberger-unet-' + str(epochs) + '-epochs-' + optimizer + '-' + loss + '.keras')
