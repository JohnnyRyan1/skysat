...
ax1.scatter(s2_df.index, s2_df['lake1'], color=c1, zorder=1, s=50, label='Sentinel-2')
ax1.scatter(lake_df.index, lake_df['lake1'], zorder=1, s=50, label='SkySat')
ax2.scatter(s2_df.index, s2_df['lake2'] + s2_df['lake3'], color=c1, zorder=1, s=50)
ax2.scatter(lake_df.index, lake_df['lake2'] + lake_df['lake3'], zorder=1, s=50)
ax3.scatter(s2_df.index, s2_df['lake4'], color=c1, zorder=1, s=50)
ax3.scatter(lake_df.index, lake_df['lake4'], zorder=1, s=50)
ax4.scatter(s2_df.index, s2_df['lake5'], color=c1, zorder=1, s=50)
ax4.scatter(lake_df.index, lake_df['lake5'], zorder=1, s=50)
ax5.scatter(s2_df.index, s2_df['lake6'], color=c1, zorder=1, s=50)
ax5.scatter(lake_df.index, lake_df['lake6'], zorder=1, s=50)
ax6.scatter(s2_df.index, s2_df['lake7'], color=c1, zorder=1, s=50)
ax6.scatter(lake_df.index, lake_df['lake7'], zorder=1, s=50)

ax1.axvline(x=pd.to_datetime('2019-06-13'), ls='dashed', color='k', lw=2)
ax2.axvline(x=pd.to_datetime('2019-06-13'), ls='dashed', color='k', lw=2)
ax3.axvline(x=pd.to_datetime('2019-06-13'), ls='dashed', color='k', lw=2)
ax4.axvline(x=pd.to_datetime('2019-06-11'), ls='dashed', color='k', lw=2)
ax5.axvline(x=pd.to_datetime('2019-06-08'), ls='dashed', color='k', lw=2)
ax6.axvline(x=pd.to_datetime('2019-06-08'), ls='dashed', color='k', lw=2)

ax1.text(0.5, 0.88, "Lake 1", transform=ax1.transAxes,
    fontsize=12, ha='center', va='bottom')
ax2.text(0.5, 0.88, "Lake 2 + 3", transform=ax2.transAxes,
    fontsize=12, ha='center', va='bottom')
ax3.text(0.5, 0.88, "Lake 4", transform=ax3.transAxes,
    fontsize=12, ha='center', va='bottom')
ax4.text(0.5, 0.88, "Lake 5", transform=ax4.transAxes,
    fontsize=12, ha='center', va='bottom')
ax5.text(0.5, 0.88, "Lake 6", transform=ax5.transAxes,
    fontsize=12, ha='center', va='bottom')
ax6.text(0.5, 0.88, "Lake 7", transform=ax6.transAxes,
    fontsize=12, ha='center', va='bottom')
...
ax4.scatter(s2_df.index, s2_df['lake12'], color=c1, zorder=2)
ax4.scatter(lake_df.index, lake_df['lake12'], zorder=3)

ax1.axvline(x=pd.to_datetime('2019-06-13'), ls='dashed', color='k', lw=2)
ax2.axvline(x=pd.to_datetime('2019-06-24'), ls='dashed', color='k', lw=2)
ax3.axvline(x=pd.to_datetime('2019-06-26'), ls='dashed', color='k', lw=2)
ax4.axvline(x=pd.to_datetime('2019-07-16'), ls='dashed', color='k', lw=2)

ax1.set_ylabel("Area (km$^2$)", fontsize=12)  
ax3.set_ylabel("Area (km$^2$)", fontsize=12)  

ax1.text(0.5, 0.88, "Lake 8", transform=ax1.transAxes,
    fontsize=12, ha='center', va='bottom')
ax2.text(0.6, 0.88, "Lake 9", transform=ax2.transAxes,
    fontsize=12, ha='center', va='bottom')
ax3.text(0.6, 0.88, "Lake 10", transform=ax3.transAxes,
    fontsize=12, ha='center', va='bottom')
ax4.text(0.4, 0.88, "Lake 12", transform=ax4.transAxes,
    fontsize=12, ha='center', va='bottom')
...
for ax in [ax1, ax2, ax3, ax4]:
    ax.tick_params(axis='both', which='major', labelsize=12)
    ax.grid(True, which="both", linestyle="--", linewidth=1, zorder=1)
    ax.set_xlim(lake_df.index[0], lake_df.index[-1])
